...
interface PromptEngineeringGameProps {
  onComplete: (score: number) => void;
}

export const PromptEngineeringGame: React.FC<PromptEngineeringGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      ...
      description="Crea prompts efectivos"
