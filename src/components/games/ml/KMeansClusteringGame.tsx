...
interface KMeansClusteringGameProps {
  onComplete: (score: number) => void;
}

export const KMeansClusteringGame: React.FC<KMeansClusteringGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      ...
      description="Agrupa datos con K-Means"
