...
interface VisualClassifierGameProps {
  onComplete: (score: number) => void;
}

export const VisualClassifierGame: React.FC<VisualClassifierGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      title="Clasificador Visual"
      description="Clasifica puntos en categorías"
      ...
      <div className="flex flex-col items-center justify-center space-y-6 py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Clasifica puntos en categorías
          </p>
        </div>
