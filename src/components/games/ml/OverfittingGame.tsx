...
interface OverfittingGameProps {
  onComplete: (score: number) => void;
}

export const OverfittingGame: React.FC<OverfittingGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      title="Overfitting Game"
      description="Encuentra el balance perfecto"
