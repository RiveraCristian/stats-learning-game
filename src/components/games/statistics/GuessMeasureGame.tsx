...
interface GuessMeasureGameProps {
  onComplete: (score: number) => void;
}

export const GuessMeasureGame: React.FC<GuessMeasureGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      title="Adivina la Medida"
      description="Calcula media, mediana y moda de datos"
      ...
      <div className="flex flex-col items-center justify-center space-y-6 py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Calcula media, mediana y moda de datos
          </p>
        </div>
