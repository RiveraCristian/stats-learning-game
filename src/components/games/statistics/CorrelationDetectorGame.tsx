...
interface CorrelationDetectorGameProps {
  onComplete: (score: number) => void;
}

export const CorrelationDetectorGame: React.FC<CorrelationDetectorGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      title="Detector de Correlación"
      description="Identifica el tipo de correlación en gráficos"
      ...
      <div className="flex flex-col items-center justify-center space-y-6 py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Identifica el tipo de correlación en gráficos
          </p>
        </div>
