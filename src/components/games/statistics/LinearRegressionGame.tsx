...
interface LinearRegressionGameProps {
  onComplete: (score: number) => void;
}

export const LinearRegressionGame: React.FC<LinearRegressionGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      ...
      description="Ajusta una línea de regresión"
