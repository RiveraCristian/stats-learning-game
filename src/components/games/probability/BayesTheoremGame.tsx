...
interface BayesTheoremGameProps {
  onComplete: (score: number) => void;
}

export const BayesTheoremGame: React.FC<BayesTheoremGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      ...
      description="Resuelve problemas de probabilidad condicional"
      ...
      <div className="flex flex-col items-center justify-center space-y-6 py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Resuelve problemas de probabilidad condicional
          </p>
        </div>
