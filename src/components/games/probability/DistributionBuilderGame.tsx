...
interface DistributionBuilderGameProps {
  onComplete: (score: number) => void;
}

export const DistributionBuilderGame: React.FC<DistributionBuilderGameProps> = ({ onComplete }) => {
  ...
  return (
    <GameTemplate
      ...
      description="Ajusta parámetros y visualiza diferentes distribuciones"
      ...
      <div className="flex flex-col items-center justify-center space-y-6 py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Ajusta parámetros y visualiza diferentes distribuciones
          </p>
        </div>
